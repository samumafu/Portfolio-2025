...
const workExperience = [
  {
    ...
    description: "Desarrollo de aplicaciones web con Next.js, React.js y PostgreSQL",
  },
  {
    title: "Desarrollador Front-end",
    company: "Digital Solutions",
    period: "2021 - 2022",
    description: "Creación de interfaces de usuario con React y TailwindCSS",
  },
];
          ...
          <section>
            ...
            <ol className="relative border-l-2 border-indigo-200 dark:border-indigo-800 ml-3">
              {workExperience.map((job, index) => (
                ...
                >
                  <div className="absolute w-24 h-1 bg-indigo-600 -left-24 top-2 rounded-full"></div>
